...
В рабочем пространстве GNS3 была размещена и соединена топология сети в соответствии с заданием. Имена устройств были изменены согласно требуемому шаблону с использованием моего имени (nsandryushin) (рис. [-@fig:001]).

![Топология сети в GNS3](image/1.png){#fig:001}

Включим захват трафика на соединении между сервером (PC5-nsandryushin) и ближайшим коммутатором (msk-nsandryushin-sw-05) для последующего анализа (рис. [-@fig:002]).
...
Далее была выполнена настройка маршрутизатора FRR (msk-nsandryushin-gw-01). В режиме конфигурации были заданы IP-адреса для интерфейсов eth0, eth1 и eth2 в соответствии с таблицей адресации, а также активированы интерфейсы командой no shutdown (рис. [-@fig:008]).
...
Затем началась настройка маршрутизатора msk-user-gw-02 под управлением ОС VyOS. В режиме конфигурации изменим имя устройства на msk-nsandryushin-gw-02, изменения были зафиксированы (commit) и сохранены (save), после чего устройство было перезагружено (рис. [-@fig:018]).
...
![Проверка конфигурации интерфейсов на маршрутизаторе msk-nsandryushin-gw-02](image/20.png){#fig:020}
