...
Установим gns3 all in one через chocolatey (рис. [-@fig:001]).

![Установка gns3](image/1.png){#fig:001 width=70%}

Выбираем все галочки для полной установки (рис. [-@fig:002]).
...
Пропишем в терминале команду для включения вложенной виртуализации (рис. [-@fig:008]).

![Вложенная вируализация](image/8.png){#fig:008 width=70%}
...
Виртуальный адаптер подключен к ниже указаной вируальной сети (рис. [-@fig:011]).

![Виртуальная сеть](image/11.png){#fig:011 width=70%}
...
Далее выбираем единственный доступный нам пункт, то есть установка на сервере (рис. [-@fig:019]).

![Выбор места установки](image/19.png){#fig:019 width=70%}
...
Устанавливаем его на главном сервере (рис. [-@fig:031]).

![Выбор сервера](image/31.png){#fig:031 width=70%}

И соглашаемся с установкой (рис. [-@fig:032]).

![Соглашение](image/32.png){#fig:032 width=70%}

Видим экран успешной установки (рис. [-@fig:033]).

![Успешная установка](image/33.png){#fig:033 width=70%}
